...
public class TrendsDetailed extends AppCompatActivity {
    ...
    TextView textView,title,senti,ttone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ttone = (TextView)findViewById(R.id.Tone);
    ...
    public void gettonesetpie(){
        ...
        senti.setText(ToneAnalysisWatson.tone.getDocumentTone().getTones().get(ToneAnalysisWatson.sentiment_position).getName());
        ttone.setText(ToneAnalysisWatson.tone.getDocumentTone().getTones().get(ToneAnalysisWatson.sentiment_position).getTones().get(ToneAnalysisWatson.sentiment_tone_position).getName());
